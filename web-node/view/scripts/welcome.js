        ...
        <div class="bd">
            <div id="сonnection_selection">
                <button class="web">
                  ...
                  <span class="title" >Join Network</span>
                </button>
                <a href="https://github.com/Eve-Ai-Labs/eve/releases" target="_blank" class="cli">
                  <svg  viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="title">Use CLI</span>
                </a>
            </div>
            <p class="description">Start participate in network using Web client or use CLI and run full node on your server/pc</p>
        </div>
    </div>
</div>`,
...
export async function init() {
  ...
  window.addEventListener(EVENTNAME_SETTINGS_CHANGED, () => {
...
export async function open() {
  ...
  document.body.insertAdjacentHTML("beforeend", TEMPLATE_WIN);
  let dialog = document.getElementById(MODAL_ID);
  dialog.querySelector(".web").addEventListener("click", () => {
    window.dispatchEvent(new CustomEvent(EVENTNAME_SETTINGS_OPEN_CALL));
  });
}
